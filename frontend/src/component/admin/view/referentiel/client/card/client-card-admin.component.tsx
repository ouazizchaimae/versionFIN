...
const ClientAdminCard = ({ libelle ,code ,description ,typeClientName , onPressDelete, onUpdate, onDetails }) =>{
        ...
        <TouchableOpacity onPress={onDetails} style={globalStyle.card}>
            <ScrollView horizontal>
                <View style={globalStyle.contentContainer}>
                    ...
                    <View style={globalStyle.infos}>
                        <Text style={globalStyle.label}>Type client: </Text>
                        <Text style={globalStyle.value}>{truncateText(typeClientName)}</Text>
                    </View>
