...
const ExpeditionProduitAdminCard = ({ code ,libelle ,description ,analyseChimiqueName ,charteChimiqueName , onPressDelete, onUpdate, onDetails }) =>{
...
export default ExpeditionProduitAdminCard;
