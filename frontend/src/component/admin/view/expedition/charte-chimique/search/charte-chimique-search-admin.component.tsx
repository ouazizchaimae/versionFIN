...
import {ClientAdminService} from '../../../../../../controller/service/admin/referentiel/ClientAdminService.service';
    ...
    const CharteChimiqueAdminSearchModal = ({ isVisible, handleSearch, handleClose, criteria, setCriteria }) => {

    const [clients, setClients] = useState<ClientDto[]>([]);
    const [produitMarchands, setProduitMarchands] = useState<ProduitMarchandDto[]>([]);


    const charteChimiqueDetailService = new CharteChimiqueDetailAdminService();
...
export default CharteChimiqueAdminSearchModal;
