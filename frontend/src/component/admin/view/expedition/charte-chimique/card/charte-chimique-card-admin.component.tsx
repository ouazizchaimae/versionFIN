...
const CharteChimiqueAdminCard = ({ code ,libelle ,description ,clientName ,produitMarchandName , onPressDelete, onUpdate, onDetails }) =>{
...
export default CharteChimiqueAdminCard;
